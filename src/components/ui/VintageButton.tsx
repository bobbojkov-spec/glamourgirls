...
export default function VintageButton({ 
  ...
  const buttonClasses = `inline-flex items-center justify-center rounded-lg px-8 py-3 text-sm font-medium tracking-wide uppercase text-[var(--text-primary)] transition-all duration-300 relative overflow-hidden group ${className}`;
  ...
  const handleMouseEnter = (e: React.MouseEvent<HTMLElement>) => {
    ...
    target.style.boxShadow = '0 10px 20px rgba(0, 0, 0, 0.15), 0 6px 10px rgba(0, 0, 0, 0.1)';
